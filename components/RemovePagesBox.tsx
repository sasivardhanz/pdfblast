...
export default function RemovePagesBox() {
  ...
  function getDownloadName() {
    ...
    return customName ? `${customName}.pdf` : "removed-pages.pdf";
  }
  ...
  async function removePages() {
    ...
    if (selectedPages.length === 0) {
      setMessage("Please select pages to remove.");
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setMessage(errorData.error || "Remove pages failed.");
        return;
      }
      ...
      setDownloadUrl(url);
      setProgress(100);
      setMessage("Selected pages removed successfully.");
    } catch {
    ...
    <div className="mx-auto w-full max-w-[750px]">
      ...
      >
        ...
        <p className="mt-3 text-base text-gray-600">
          Select pages manually and remove them from your PDF.
        </p>
      ...
      {file && (
        <div className="mt-5 space-y-4">
          ...
          {totalPages > 0 && (
            <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-center">
              <p className="font-semibold text-blue-700">
                This PDF has {totalPages} pages. Select pages to remove.
              </p>
            </div>
          )}
          ...
          {totalPages > 0 && (
            <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
              ...
              <p className="mt-3 text-xs text-gray-500">
                Selected pages will be removed. Selected:{" "}
          ...
          <button
            ...
            onClick={removePages}
            disabled={processing}
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-red-600 px-8 py-4 font-semibold text-white hover:bg-red-500 disabled:opacity-60"
          >
            <Trash2 size={18} />
            {processing ? "Removing..." : "Remove Selected Pages"}
          </button>
