...
export default function RotatePdfBox() {
  ...
  function getDownloadName() {
    ...
    return customName ? `${customName}.pdf` : "rotated-pdf.pdf";
  }
  ...
  return (
    <div className="mx-auto w-full max-w-[650px]">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-gray-900">Upload PDF to Rotate</h2>
