...
export default function ProtectPdfBox() {
  ...
  function getDownloadName() {
    ...
    return customName ? `${customName}.pdf` : "protected-pdf.pdf";
  }
  ...
  async function protectPdf() {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setMessage(errorData.error || "Protect PDF failed.");
        return;
      }
        ...
        <div className="mt-5 space-y-4">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <input
              ...
              placeholder="Example: secure-document"
              className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm outline-none focus:border-blue-500"
            />

            <p className="mt-2 text-xs text-gray-500">
              Leave empty to download as protected-pdf.pdf
            </p>
          </div>
