import ProtectPdfBox from "@/components/ProtectPdfBox";
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="mx-auto max-w-5xl px-6 py-14 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-gray-600">
          Secure your PDF with a password and download a protected copy.
        </p>
      ...
      <section className="mx-auto grid max-w-5xl gap-5 px-6 pb-20 md:grid-cols-3">
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          <Lock className="mb-4 text-blue-600" />
          <h3 className="font-semibold">Password Lock</h3>
          <p className="mt-2 text-sm leading-6 text-gray-600">
            Add a password to restrict opening your PDF.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            Useful for resumes, invoices and private files.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            Rename and download your protected PDF instantly.
          </p>
        </div>
      </section>
    </main>
