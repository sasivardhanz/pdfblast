import UnlockPdfBox from "@/components/UnlockPdfBox";
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="mx-auto grid max-w-5xl gap-5 px-6 pb-20 md:grid-cols-3">
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          <Unlock className="mb-4 text-blue-600" />
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            Rename and download your
            unlocked PDF instantly.
          </p>
        </div>
      </section>
    </main>
